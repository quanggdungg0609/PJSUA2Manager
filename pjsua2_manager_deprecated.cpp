...
/**
 * @class PJSUA2Manager
 * @brief Manages SIP logic using PJSUA2 including account, calls, and event handling.
 */
class PJSUA2Manager{
    private:
    ...
    public:
        ...
        /**
         * @brief Destructor: Cleans up SIP endpoint and all resources.
        */
        ~PJSUA2Manager(){
            stop_event_loop();
            _activeCalls.clear();
        ...
        /**
         * @brief Constructor: Initializes SIP endpoint, configures account, transport, codecs, and sets callbacks.
         * 
         * @param sip_user SIP username
         * @param sip_password SIP password
         * @param sip_domain SIP domain or server address
         * @param onIncomingCallCb Callback function for incoming calls
         * @param onRegStateCb Callback function for registration state updates
         * @param onCallStateCb Callback function for call state changes
         * @param onErrorCb Callback function for error handling
         */
        PJSUA2Manager(
        ...
        /**
         * @brief Starts the SIP event loop using libHandleEvents.
         * 
         * @param timeout_ms Timeout in milliseconds for each event loop iteration.
         */
